...
run_name = f"MLP_{HIDDEN_LAYERS}_lr{LEARNING_RATE}_act{ACTIVATION}"
file_name = f"figures/mlp_report_{run_name}.png"
...
with mlflow.start_run(run_name=run_name):
    ...
    print(f"Modèle           : MLP {HIDDEN_LAYERS}")
